...
The voice, the quote voice and the reading pace are chosen once on the Voice
page and then used by every build that does not name its own. They live in the
